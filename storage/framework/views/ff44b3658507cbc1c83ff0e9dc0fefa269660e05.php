            ...
            <?php echo Form::open(['url' => 'admin/add_company', 'class' => 'form-horizontal','files' => true,'id'=>'company_form']); ?>
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  ...
                  <select class ='form-control' id = 'input_status' name='country_code' >
                    <?php $__currentLoopData = $country_code_option; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country_code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e(@$country_code->phone_code); ?>"><?php echo e($country_code->long_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                    <!-- <?php echo Form::select('country_code', $country_code_option, '', ['class' => 'form-control', 'id' => 'input_status', 'placeholder' => 'Select']); ?> -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <?php echo Form::file('license', ['class' => 'form-control', 'id' => 'input_license', 'accept' => 'image/*']); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <?php echo Form::text('license_exp_date', '', ['class' => 'form-control', 'id' => 'license_exp_date', 'placeholder' => 'License Expiry Date', 'autocomplete' => 'off']); ?>

                    <span class="text-danger"><?php echo e($errors->first('license_exp_date')); ?></span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <?php echo Form::text('insurance_exp_date', '', ['class' => 'form-control', 'id' => 'insurance_exp_date', 'placeholder' => 'Insurance Expiry Date', 'autocomplete' => 'off']); ?>

                    <span class="text-danger"><?php echo e($errors->first('insurance_exp_date')); ?></span>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo e(url(LOGIN_USER_TYPE.'/company')); ?>"><span class="btn btn-default pull-left">Cancel</span></a>
              </div>
              <!-- /.box-footer -->
            <?php echo Form::close(); ?>
