    ...
    <div class="row">
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-dblue">
          <div class="inner">
            <h3> <?php echo e($currency_code.' '.round($total_revenue)); ?></h3>
            <p>Total Earnings</p>
          </div>
          <div class="icon">
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-yellow">
          <div class="inner">
            <h3><?php echo e(round($admin_paid_amount)); ?></h3>
    ...
    <div class="row">
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-light-blue">
          <div class="inner">
            <h3><?php echo e($currency_code.' '.round($today_revenue)); ?></h3>
            <p>Today Earnings</p>
          </div>
          <div class="icon">
            <i class="fa fa-dollar"></i>
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-orange">
          <div class="inner">
            <h3><?php echo e(round($admin_pending_amount)); ?></h3>
