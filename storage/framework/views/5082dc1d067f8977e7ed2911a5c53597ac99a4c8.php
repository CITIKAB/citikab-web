  ...
  <?php echo Html::script('js/responsiveslides.js'); ?>
...
<script src="<?php echo e(url('js/accountkit.js')); ?>"></script>
<?php endif; ?>
...
<script src="<?php echo e(url('js/googleapilogin.js?v1=1.0')); ?>"></script>
<?php endif; ?>
