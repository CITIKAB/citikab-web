...
<div class="container" >
<div class="pad-44">
<h1 class="slide-head"><?php echo e(trans('messages.home.title')); ?></h1><p class="slide-content"><?php echo e(trans('messages.home.desc')); ?></p></div>
...
<?php echo e(Form::open(array('url' => 'driver_register','class' => 'layout layout--flush section-drive-hero soft portable-soft-large'))); ?>


<?php if(Auth::user()==null): ?>
<div class="layout__item one-whole">
<div class="home__preview-rider-image float--left"></div>
<div class="float--left ride-header">	<h4 class="flush hard"> <?php echo e(trans('messages.user.ride_with')); ?> <?php echo e($site_name); ?></h4>
<a class="btn btn--link hard--bottom rider-signup text--uppercase primary-font--bold  borderless--left" href="<?php echo e(url('signup_rider')); ?>"><!-- react-text: 6995 --><?php echo e(trans('messages.home.siginup')); ?><!-- /react-text -->
<i class="icon icon_right-arrow push-tiny--left"></i></a>
</div></div><div class="background-line">
<span class="push-tiny--sides text--uppercase small"><?php echo e(trans('messages.home.or')); ?></span></div>
<div class="layout__item one-whole margin-medium margin-side">
<div class="home__preview-driver-image float--left"></div>


<div class="float--left ride-header">	<h4 class="flush hard "><?php echo e(trans('messages.home.siginup_drive')); ?></h4>
<a class="btn btn--link hard--bottom rider-signup text--uppercase primary-font--bold  borderless--left" href="<?php echo e(url('signup_driver')); ?>"><!-- react-text: 6995 --><?php echo e(trans('messages.home.siginup')); ?><!-- /react-text -->
<i class="icon icon_right-arrow push-tiny--left"></i></a>
</div>
...
<div class="float--left ride-header">	<h4 class="flush hard"><?php echo e(trans('messages.home.siginup_company')); ?></h4>
<a class="btn btn--link hard--bottom rider-signup text--uppercase primary-font--bold borderless--left" href="<?php echo e(url('signup_company')); ?>"><!-- react-text: 6995 --><?php echo e(trans('messages.home.siginup')); ?><!-- /react-text -->
<i class="icon icon_right-arrow push-tiny--left"></i></a>
</div>
<?php endif; ?>
</div>
...
<div class="">
<?php echo Form::text('first_name', '', ['class' => 'text-input text-input--joined flush--bottom border--left border--ends'.($errors->has('first_name') ? ' error-border' : ''),'placeholder' => trans('messages.user.firstname'),'id' => 'fname','style'=>'border-left: 1px solid #E5E5E4;' ]); ?>

</div></div><div class="layout__item one-half">
<div class="">	
	<?php echo Form::text('last_name', '', ['class' => 'text-input text-input--joined--right flush--bottom border--sides border--ends'.($errors->has('last_name') ? ' error-border' : ''),'placeholder' => trans('messages.user.lastname'),'id' => 'lname','style'=>'border-left: 1px solid #E5E5E4;' ]); ?>

</div></div>
<div class="layout__item one-whole push-tiny--bottom">
	<div class="">
		<?php echo Form::email('email', '', ['class' => 'text-input border--top border--sides'.($errors->has('email') ? ' error-border' : ''),'placeholder' => trans('messages.user.email') ,'style'=>'border-top: 1px solid #E5E5E4;']); ?>

	</div>
</div>
<div class="layout col-md-12 layout--flush float mobile-container left two-char">
	<div class="layout__item" id="country">
		<div id="select-title-stage" style="padding: 14px 8px;"> +<?php echo e(old('country_code',1)); ?> </div>
		<div class="select select--xl">
			...
			<?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<option value="<?php echo e($value->phone_code); ?>" data-value="+<?php echo e($value->phone_code); ?>"><?php echo e($value->long_name); ?>
	...
	<div class="layout__item number">
		...
		<div class="layout layout--flush col-md-12 container-field clearfix push-small--bottom">
			<div class="field">
				...
				<?php echo Form::tel('mobile_number', '', ['class' => 'text-input flush--bottom border--top border--sides'.($errors->has('mobile_number') ? ' error-border' : ''),'placeholder' => trans('messages.profile.mobile') ]); ?>
...
<?php echo Form::password('password', array('class' => 'text-input border--ends border--sides'.($errors->has('password') ? ' error-border' : ''),'placeholder' => trans('messages.user.paswrd'),'id' => 'password') ); ?> 
</div></div>
...
<button name="step" value="basics" class="btn btn--primary btn--arrow position--relative btn--full error-retry-btn" style="box-sizing:border-box;text-decoration:none;color:#FFFFFF;display:inline-block;vertical-align:middle;text-align:center;margin:0;cursor:pointer;overflow:visible;background-color:#11939A;font-family:ff-clan-web-pro, &quot;Helvetica Neue&quot;, Helvetica, sans-serif;font-weight:600;font-size:14px;padding:11px 20px;border-radius:0px;border:2px solid #11939A;text-transform:uppercase;outline:none;line-height:18px;position:relative;transition:all 400ms ease;-moz-box-sizing:border-box;-webkit-transition:all 400ms ease;" ><?php echo e(trans('messages.home.siginup_drive')); ?><i class="icon_right-arrow-thin icon transition delta position--absolute"></i>
                </button>
</div>
<input type="submit" hidden="">
<div class="layout__item one-whole"><div class="push-tiny--bottom"><?php echo e(trans('messages.home.or')); ?> <a href="<?php echo e(url('signup_rider')); ?>"><?php echo e(trans('messages.home.siginup')); ?></a> <?php echo e(trans('messages.home.rider_acnt')); ?> </div><p class="legal-disclaimer flush"> <?php echo e(trans('messages.user.proceed')); ?><?php echo e($site_name); ?><?php echo e(trans('messages.user.contact')); ?></p></div></div> --> <?php echo e(Form::close()); ?></div></div>
...
<h2 class="cont-h2"><?php echo e(trans('messages.home.easy_way')); ?></h2>
<p class="cont-p"><?php echo e(trans('messages.home.easy_content')); ?></p>
</div>
<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mar-height" style="padding-right: 20px; padding-left: 20px;">
<img src="images/icon/cont2.png" class="cont-img">
<h2 class="cont-h2"><?php echo e(trans('messages.home.anywhere')); ?></h2>
<p class="cont-p"><?php echo e(trans('messages.home.anywhere_content')); ?></p>
</div>
<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mar-height" style="padding-right: 20px; padding-left: 20px;">
<img src="images/icon/cont3.png" class="cont-img">
<h2 class="cont-h2"><?php echo e(trans('messages.home.lowcost')); ?></h2>
<p class="cont-p"><?php echo e(trans('messages.home.lowcost_content')); ?></p>
</div>
</div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
<a class="btn btn--primary btn--arrow position--relative error-retry-btn" href="<?php echo e(url('ride')); ?>" style="margin-top:50px;margin-left: 20px !important;">
<div class="block-context soft-small--right" style="    width: 190px;"><?php echo e(trans('messages.home.reason')); ?></div>
<i class="icon_right-arrow-thin icon transition delta position--absolute"></i>
	...
	<h2 class="com-head" style="font-weight:normal;letter-spacing:2px;"><?php echo e(trans('messages.home.drive_you')); ?></h2>
	<h3 class="com-head"><?php echo e(trans('messages.home.you_need')); ?></h3>
	</div>
	<div class="com-content"><p class="cmln__paragraph"><?php echo e(trans('messages.home.drive_with')); ?><?php echo e($site_name); ?><?php echo e(trans('messages.home.goals')); ?></p>
</div><a class="btn btn--primary btn--arrow position--relative error-retry-btn" href="<?php echo e(url('drive')); ?>">
<div class="block-context soft-small--right" style="    width: 180px;"><?php echo e(trans('messages.home.reason')); ?></div>
<i class="icon_right-arrow-thin icon transition delta position--absolute"></i>
</a></div>
	</div>
	</div>
...
<div style="position: relative !important;"><p class="_style_ZJW1y ride-support" style="
    margin-bottom: 25px !important;"><?php echo e(trans('messages.home.suprt')); ?></p>
</div><div><p class="cmln__paragraph ride-para"><?php echo e(trans('messages.home.provide')); ?></p>
</div></div>
	</div>
</div>
</div>
...
<div class="container pad-container-small" data-reactid="328">
	<div class="" data-reactid="329"><div class="_style_VxPAE" data-reactid="330"><p class="_style_ZJW1y" data-reactid="331"><?php echo e(trans('messages.home.now_arrive')); ?></p><h2 style="margin-bottom:40px !important;" class="_style_3zaJwR" data-reactid="332"><?php echo e(trans('messages.home.safe')); ?></h2></div>
	</div>
...
<div style="position: relative !important;"><p class="_style_ZJW1y" style="
    margin-bottom: 25px !important;"><?php echo e(trans('messages.home.helping')); ?></p>
</div><div><p class="cmln__paragraph"><?php echo e(trans('messages.home.city_with')); ?> <?php echo e($site_name); ?> <?php echo e(trans('messages.home.city_with_content')); ?></p>
</div></div>
	</div>
	...
	<div class="arrive-content">
<div style="position: relative !important;"><p class="_style_ZJW1y" style="    
    margin-bottom: 25px !important;"><?php echo e(trans('messages.home.safe_ride')); ?></p>
</div><div><p class="cmln__paragraph"><?php echo e(trans('messages.home.backseat')); ?> <?php echo e($site_name); ?><?php echo e(trans('messages.home.designed')); ?></p>
</div></div>
	</div>
	</div>
	</div>
