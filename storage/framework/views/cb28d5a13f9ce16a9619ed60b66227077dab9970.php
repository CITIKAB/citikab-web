              ...
              <div class="box-body">                
                <div class="form-group">
                  ...
                  <div class="input-group"> 
                    <?php echo Form::text('access_fee', $result[0]->value, ['class' => 'form-control', 'id' => 'input_service_fee', 'placeholder' => 'Rider Service Fee']); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <div class="input-group"> 
                      <?php echo Form::text('driver_peak_fare', $result[1]->value, ['class' => 'form-control', 'id' => 'input_driver_peak_fare', 'placeholder' => 'Driver Peak Fare']); ?>

                      <div class="input-group-addon" style="background-color:#eee;">%</div>
                      <span class="text-danger"><?php echo e($errors->first('input_driver_peak_fare')); ?></span>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <div class="input-group"> 
                      <?php echo Form::text('driver_service_fee', $result[2]->value, ['class' => 'form-control', 'id' => 'input_driver_service_fee', 'placeholder' => 'Driver Service Fee']); ?>
