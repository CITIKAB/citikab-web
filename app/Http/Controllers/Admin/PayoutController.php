	...
	*/
    public function payout_to_driver(Request $request)
    {
        ...
        if($payout_details == null) {
            $this->helper->flash_message('danger', 'Yet, driver doesn\'t enter his Payout details. Cannot Paid.');
            return back();
        }

    	$this->make_driver_payout($type, $payout_details, $trip_currency, $trip_amount, $trip_ids);
