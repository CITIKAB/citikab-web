           ...
           /* $niceNames = array(
            ...
            else
            {
               /* PaymentGateway::where(['name' => 'app_id', 'site' => 'PayPal'])->update(['value' => $request->app_id]);
                ...
                PaymentGateway::where(['name' => 'merchant_id', 'site' => 'Gladepay'])->update(['value' => $request->merchant_id]);
                PaymentGateway::where(['name' => 'merchant_key', 'site' => 'Gladepay'])->update(['value' => $request->merchant_key]);
                PaymentGateway::where(['name' => 'url', 'site' => 'Gladepay'])->update(['value' => $request->url]);
