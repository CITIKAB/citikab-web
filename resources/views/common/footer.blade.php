		...
		<div class="footer-head">
			...
			<div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
				<div class="currency_select">
					{!! Form::select('language',$language, (Session::get('language')) ? Session::get('language') : $default_language[0]->value, ['class' => 'select payment-select paysel', 'aria-labelledby' => 'language-selector-label', 'id' => 'js-language-select','style'=>"width: 100%; background-color: #000;"]) !!}
				</div>
			</div>
			<div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
				<div class="currency_select">
