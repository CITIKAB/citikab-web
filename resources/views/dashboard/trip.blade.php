    ...
    <div class="hidden--palm">
        <div class="page-lead text-center">
            <div class="flexbox">
                ...
                <a data-toggle="collapse" id="show-filter" href="#trip-filterer" class="trip-filter__origin-link collapsed hide-sm-760"><span class="icon icon_settings-alt color--dark soft-half--right"></span>{{trans('messages.profile.filter')}}</a>
                </div>
                <div class="flexbox__item col-lg-4 col-md-4 col-sm-4 col-xs-12"><h1 class="flush flush-h1">{{trans('messages.header.mytrips')}}</h1></div>
    ...
    <div id="trip-filters" class="trip-filters">
        ...
        <div class="trip-filter__item" ng-if="!selected_filter" style="overflow:hidden;">
            <div class="grid">
                ...
                <h3 class="gamma" style="margin:0px;">{{trans('messages.profile.timeframe')}}</h3>
                </div>
        ...
        <div class="trip-filter__item tripvalue" ng-if="selected_filter">
            <div class="grid grid--full filtertrip">
                <!-- <div class="grid__item one-twelfth trip-filter__header gridfull">
                        <a href="{{ url('trip')}}" data-replace="data-replace" class="fa fa-close close_style closebtn"></a>
                </div> -->
                <div class="grid__item eleven-twelfths cf filtercheck">
                    <div data-button-loader="#month-filter-loader" data-button-loader-parent="false" class="btn-group btn-group--bordered btn-group--joined inline-group push--right float--left btninput ">
                        <div class="inline-group__item inlinebtn" style="width: 100px;">
                            <a href="{{ url('trip')}}" data-replace="data-replace" class="btn btn--primary month-cls custom-cls customvalue" style="    background-color: #1ca7c0 !important;border-color: #1ca7c0 !important;height: 28px;"><span class="btn-loader collapse" id="month-filter-loader">
     ...
     <table class="col-sm-12 table-bordered table-striped table-condensed cf">
        <thead class="cf">
            <tr>
                ...
                <th class="hide-sm">{{trans('messages.profile.driver')}}</th>
...
<ul class="nav nav--stacked soft-half--top  center-block col-lg-9 col-md-9 col-sm-9 col-xs-12"><li class="push-half--bottom"><form method="post" action="{{ url('trips/resend_receipt')}}" data-replace="data-replace" data-replace-pushstate="false"><input type="hidden" name="x-csrf-token" value="eBYrQqLCtPkRHpYKWiJe9ZqMCag6UtCe">
...
<a href="{{ url('trip_detail') }}/@{{ trip.id}}" class="btn-group btn-group--bordered btn-group--joined inline-group"><div class="inline-group__item">
