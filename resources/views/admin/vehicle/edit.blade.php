      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-offset-2 ne_ed">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(['url' => LOGIN_USER_TYPE.'/edit_vehicle/'.$result->id, 'class' => 'form-horizontal','files' => true,'id'=>'vehicle_form']) !!}
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                      {!! Form::select('vehicle_id', $car_type,@$result->vehicle_id, ['class' => 'form-control', 'id' => 'input_status', 'placeholder' => 'Select']) !!}
