            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('twillo_sid', $result[2]->value, ['class' => 'form-control', 'id' => 'input_twillo_sid', 'placeholder' => 'Twillo SID']) !!}
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('twillo_token', $result[3]->value, ['class' => 'form-control', 'id' => 'input_twillo_token', 'placeholder' => 'Twillo Token']) !!}
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('twillo_from', $result[4]->value, ['class' => 'form-control', 'id' => 'input_twillo_from', 'placeholder' => 'Twillo From Number']) !!}
