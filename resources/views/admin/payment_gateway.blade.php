            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('merchant_id', @$result[0]->value, ['class' => 'form-control', 'id' => 'input_merchant_id', 'placeholder' => 'Merchant ID']) !!}
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('merchant_key', @$result[1]->value, ['class' => 'form-control', 'id' => 'input_merchant_key', 'placeholder' => 'Merchant Key']) !!}
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::select('url', array('https://demo.api.gladepay.com/payment' => 'Sandbox', 'https://api.gladepay.com/payment' => 'Live'), $result[2]->value, ['class' => 'form-control', 'id' => 'input_paypal_mode']) !!}
