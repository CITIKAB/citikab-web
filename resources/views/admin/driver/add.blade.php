            ...
            {!! Form::open(['url' => LOGIN_USER_TYPE.'/add_driver', 'class' => 'form-horizontal','files' => true]) !!}
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
               ...
               <!--  <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('mobile_number', '', ['class' => 'form-control', 'id' => 'input_mobile_number', 'placeholder' => 'Phone No']) !!}
               ...
               <!--  <div class="form-group">
                ...
                @if (LOGIN_USER_TYPE!='company')
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      {!! Form::select('company_name', $company, '', ['class' => 'form-control', 'id' => 'input_company_name', 'placeholder' => 'Select']) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::select('status', array('Active' => 'Active', 'Inactive' => 'Inactive', 'Pending' => 'Pending', 'Car_details' => 'Car_details', 'Document_details' => 'Document_details'), '', ['class' => 'form-control', 'id' => 'input_status', 'placeholder' => 'Select']) !!}
                  ...
                  <span class="bank_detail">
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                           ...
                           {!! Form::text('account_holder_name','', ['class' => 'form-control', 'id' => 'account_holder_name', 'placeholder' => 'Account Holder Name']) !!}
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                           ...
                           {!! Form::text('bank_name','', ['class' => 'form-control', 'id' => 'bank_name', 'placeholder' => 'Name of Bank']) !!}
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                           ...
                           {!! Form::text('bank_location','', ['class' => 'form-control', 'id' => 'bank_location', 'placeholder' => 'Bank Location']) !!}
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                           ...
                           {!! Form::text('bank_code','', ['class' => 'form-control', 'id' => 'bank_code', 'placeholder' => 'BIC/SWIFT Code']) !!}
