          ...
          <div class="box-body" ng-init="time_options={{ json_encode($time_options) }};day_options={{json_encode($day_options)}};">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6" ng-init="vehicle_type='{{ old('vehicle_type','') }}'">
                {!! Form::select('vehicle_type', $vehicle_types, '', ['class' => 'form-control', 'id' => 'input_location']) !!}
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('base_fare', '', ['class' => 'form-control', 'id' => 'input_name', 'placeholder' => 'Base Fare']) !!}
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('capacity', '', ['class' => 'form-control', 'id' => 'input_name', 'placeholder' => 'Capacity']) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('min_fare', '', ['class' => 'form-control', 'id' => 'input_name', 'placeholder' => 'Minimum Fare']) !!}
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('per_min', '', ['class' => 'form-control', 'id' => 'input_name', 'placeholder' => 'Per Minutes']) !!}
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('per_km', '', ['class' => 'form-control', 'id' => 'input_name', 'placeholder' => 'Per Kilometer']) !!}
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('schedule_fare', '', ['class' => 'form-control', 'id' => '', 'placeholder' => 'Schedule Ride Fare']) !!}
