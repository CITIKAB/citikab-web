        ...
        <div class="box box-info">
          ...
          <div class="box-body" ng-init="time_options={{ json_encode($time_options) }};day_options={{json_encode($day_options)}};">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                {!! Form::select('vehicle_type', $vehicle_types, old('vehicle_type',$result->vehicle_id), ['class' => 'form-control', 'id' => 'input_location','placeholder' => 'Select']) !!}
            ...
            <div class="form-group">
                  <label for="input_name" class="col-sm-3 control-label">Base Fare<em class="text-danger">*</em></label>

                  <div class="col-sm-6">
                    {!! Form::text('base_fare', $result->base_fare, ['class' => 'form-control', 'id' => 'input_name', 'placeholder' => 'Base Fare']) !!}
                    <span class="text-danger">{{ $errors->first('base_fare') }}</span>
                  </div>
                </div>
                <div class="form-group">
                  <label for="input_name" class="col-sm-3 control-label">Capacity<em class="text-danger">*</em></label>

                  <div class="col-sm-6">
                    {!! Form::text('capacity', $result->capacity, ['class' => 'form-control', 'id' => 'input_name', 'placeholder' => 'Capacity']) !!}
                    <span class="text-danger">{{ $errors->first('capacity') }}</span>
                  </div>
                </div>
                <div class="form-group">
                  <label for="input_name" class="col-sm-3 control-label">Minimum Fare<em class="text-danger">*</em></label>

                  <div class="col-sm-6">
                    {!! Form::text('min_fare',  $result->min_fare, ['class' => 'form-control', 'id' => 'input_name', 'placeholder' => 'Minimum Fare']) !!}
                    <span class="text-danger">{{ $errors->first('min_fare') }}</span>
                  </div>
                </div>
              <div class="form-group">
                  <label for="input_name" class="col-sm-3 control-label">Per Minutes<em class="text-danger">*</em></label>

                  <div class="col-sm-6">
                    {!! Form::text('per_min', $result->per_min, ['class' => 'form-control', 'id' => 'input_name', 'placeholder' => 'Per Minutes']) !!}
                    <span class="text-danger">{{ $errors->first('per_min') }}</span>
                  </div>
                </div>
              <div class="form-group">
                  <label for="input_name" class="col-sm-3 control-label">Per Kilometer<em class="text-danger">*</em></label>

                  <div class="col-sm-6">
                    {!! Form::text('per_km', $result->per_km, ['class' => 'form-control', 'id' => 'input_name', 'placeholder' => 'Per Kilometer']) !!}
                    <span class="text-danger">{{ $errors->first('per_km') }}</span>
                  </div>
                </div>

              <div class="form-group">
                  <label for="input_name" class="col-sm-3 control-label">Schedule Ride Fare<em class="text-danger">*</em></label>
                  <div class="col-sm-6">
                    {!! Form::text('schedule_fare', $result->schedule_fare, ['class' => 'form-control', 'id' => '', 'placeholder' => 'Schedule Ride Fare']) !!}
                        ...
                        <div class="row">
                          <div class="col-md-3">
                            <div class="input-addon">
                              ...
                              <select name="night_fare_details[start_time]" ng-model="night_fare_details.start_time" id="night_fare_starttime" class="peak_fare_details form-control">
                                <option value="" disabled>Select</option>
                                <option  ng-repeat="(key, value) in time_options" value="@{{ key }}" ng-selected="key == night_fare_details.start_time">@{{value}}</option>
                              </select>
                              <span class="input-suffix"></span>
                            </div>
                            <span class="text-danger">@{{ errors['night_fare_details.start_time'][0] }}</span>
                          </div>
                          <div class="col-md-3">
                            <div class="input-addon">
                              <label>
                              ...
                              <select name="night_fare_details[end_time]" ng-model="night_fare_details.end_time" id="night_fare_endtime" class="peak_fare_details form-control">
                                <option value="" disabled>Select</option>
                                <option  ng-repeat="(key, value) in time_options" value="@{{ key }}" ng-selected="key == night_fare_details.end_time">@{{value}}</option>
                              </select>
                              <span class="input-suffix"></span>
                            </div>
                            <span class="text-danger">@{{ errors['night_fare_details.end_time'][0] }}</span>
                          </div>
                          <div class="col-md-3 night-fare-wrap">
                            ...
                            <span class="text-danger">@{{ errors['night_fare_details.price'][0] }}</span>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div class="box-footer">
            <button type="submit" class="btn btn-info pull-right" name="submit" value="submit" ng-click="disableButton($event)">Submit</button>
