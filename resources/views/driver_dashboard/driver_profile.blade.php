...
<div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 25px 0px 15px;">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="col-lg-7 col-md-8 col-sm-10 col-xs-10" style="padding:6px 0px;">
      <input class="_style_3vhmZK" id="mobile" name="mobile_number" value="{{ @$result->mobile_number}}" placeholder="{{trans('messages.profile.mobile')}}">
      <span class="text-danger">{{ $errors->first('mobile_number') }}</span>
    </div>
    <!-- <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12" style="margin-left: 5px;padding:6px 0px;">
      <input type="button" class="_style_3vhmZK" name="change_number" value="{{ trans('messages.profile.change') }}" id="submit-btn" ng-click="showPopup()">
    </div> -->
  </div>
</div>
<div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 25px 0px 15px;">
