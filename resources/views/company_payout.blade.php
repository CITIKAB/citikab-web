...
<div id="taxes"></div>
  ...
  <form class="modal-add-payout-pref" action="{{ url('company/payout_preferences') }}" id="add_payout_method" method="post" id="address">
    {!! Form::token() !!}
    ...
    <div class="panel-footer payout_footer">
      <input style="margin-left: 80%;" type="submit" value="{{ trans('messages.user.submit') }}" class="btn btn-primary" >
    </div>
  </form>
</div>
</div>
