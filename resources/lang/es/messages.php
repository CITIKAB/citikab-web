...
return [
	...
	'user' => [
		...
		'register_successfully' => 'Error de inicio de sesion. Consulta tu correo electrónico / contraseña.',
		'login_failed' => 'Error de inicio de sesion.',
		'google_login_failed' => 'Error de inicio de sesion.',
		'country_code' => 'Tipo de usuario',
		'user_type' => 'Nombre de vehículos',
		'veh_name' => 'Número de vehículo',
		'veh_no' => 'tipo de vehiculo',
		'veh_type' => 'Token ha caducado.',
		'token' => 'Simbolo no valido.',
		'invalid_token' => 'Nueva contraseña',
		'new_paswrd' => 'Confirmar contraseña',
		'cnfrm_paswrd' => 'La contraseña ha cambiado correctamente.',
		'pswrd_chnge' => 'Imagen de perfil',
		'profile_image' => 'No se pudo cargar Licencia de la imagen',
		'license_image' => 'actualizado correctamente',
		'update_success' => 'No se pudo cargar Imagen del perfil',
		'update_fail' => 'Tipo de archivo invalido. Sólo se aceptan tipos JPG, GIF y PNG.',
		'invalid_file_type' => 'No se pudo cargar imagen Seguro',
		'insurance_image' => 'No se pudo cargar Rc libro Imagen',
		'rc_image' => 'No se pudo cargar Permiso Imagen',
		'permit_image' => 'Agregado exitosamente',
		'add_success' => 'rc libro',
		'rc_book' => 'Seguro',
		'insurance' => 'Permiso',
		'permit' => 'Métodos de pago',
