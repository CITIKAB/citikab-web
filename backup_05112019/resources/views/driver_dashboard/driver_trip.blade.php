    ...
    <div id="no-more-tables" class="more-table-trips">
        <table class="col-sm-12 table-bordered table-striped table-condensed cf">
            ...
            <tbody class="all-trips-table" ng-init="trips={{ $trips }};currentPage=trips.current_page;Pages=trips.last_page;" ng-repeat="trip in trips" ng-cloak>
                <tr class="trip-expand__origin collapsed"  data-toggle="collapse" data-target="#trip-@{{ trip.id}}" ng-cloak>
                    ...
                    <td data-title="Fare"><span ng-bind-html="trip.currency.original_symbol"></span>&nbsp;@{{ trip.total_invoice}}<br><span class="text-danger">@{{ trip.status }}</span></td>
        ...
        <div class="flexbox__item col-lg-4 col-md-4 col-sm-6 palm-one-whole lap-one-half soft--sides">
            <h3 class="alpha push-half--bottom" style="margin: 0px 0px 10px 0px !important; font-weight: 600;"><!-- ₹ -->
                <span ng-bind-html="trip.currency.original_symbol"></span>&nbsp;@{{ trip.total_invoice}}</h3>
