...
<div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="    padding: 25px 0px 15px;">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 image-show"  data-title="Driver's License - (Back/Reverse)" style="cursor: pointer;">
...
<div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="    padding: 25px 0px 15px;">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 image-show" data-title="Driver's License - (Front)" style="cursor: pointer;">
...
@if(Auth::user()->company_id==1)
  <div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="    padding: 25px 0px 15px;">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 image-show" data-title="Motor Insurance Certificate" style="cursor: pointer;">
  ...
  <div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="    padding: 25px 0px 15px;">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 image-show" data-title="Certificate of Registration" style="cursor: pointer;">
  ...
  <div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="    padding: 25px 0px 15px;">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 image-show" data-title="Contract Carriage Permit" style="cursor: pointer;">
