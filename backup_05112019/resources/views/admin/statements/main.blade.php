...
<script>
  ...
  table_columns.push(
    ...
    {data: 'commission',name: 'access_fee',title: 'Admin commission',searchable: false},
    {data: 'admin_payout_status',name: 'admin_payout_status',title: 'Admin Payout Status',searchable: false},
    {data: 'dated_on',name: 'created_at',title: 'Dated on'},
    {data: 'status',name: 'trips.status',title: 'Status'},
    {data: 'total_amount',name: 'trips.driver_payout',title: 'Earned'}
  );
