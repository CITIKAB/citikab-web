    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        @endif
         ...
         @if(@$user->can('manage_car_type'))
          <li class="{{ (Route::current()->uri() == 'admin/car_type') ? 'active' : ''  }}"><a href="{{ url('admin/car_type') }}"><i class="fa fa-car"></i><span>Manage Vehicles Type</span></a></li>
        @endif
        ...
        @if(@$user->can('manage_wallet') || @$user->can('manage_promo_code'))
          <li class="treeview {{ (Route::current()->uri() == 'admin/wallet' || Route::current()->uri() == 'admin/promo_code') ? 'active' : ''  }}">
          <a href="#">
          ...
          <ul class="treeview-menu">
            @if($company_user || @$user->can('manage_wallet'))
             <li class="{{ (Route::current()->uri() == 'admin/wallet') ? 'active' : ''  }}"><a href="{{ url('admin/wallet') }}"><i class="fa fa-circle-o"></i><span>Manage Wallet Amount</span></a></li>
            @endif
