              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('home_location', @$location->home_location, ['class' => 'form-control', 'id' => 'input_home_location', 'placeholder' => 'Home Location']) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('work_location', @$location->work_location, ['class' => 'form-control', 'id' => 'input_work_location', 'placeholder' => 'Work Location']) !!}
