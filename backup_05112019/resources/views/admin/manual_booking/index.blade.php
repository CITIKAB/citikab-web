					...
					<div class="fare-table clearfix">
						...
						<div class="row">
							...
							<div class="col-md-4" ng-cloak>
								{{$default_currency->symbol}}@{{vehicle_detail_minimum_fare | number: 2}}
							</div>
						</div>
						<div class="row">
							<div class="col-md-8">
							...
							<div class="col-md-4" ng-cloak>
								{{$default_currency->symbol}}@{{vehicle_detail_base_fare | number: 2}}
							</div>
						</div>
						<div class="row">
							<div class="col-md-8">
							...
							<div class="col-md-4" ng-cloak>
								{{$default_currency->symbol}}@{{vehicle_detail_km_fare | number: 2}}
							</div>
						</div>
						<div class="row">
							<div class="col-md-8">
							...
							<div class="col-md-4" ng-cloak>
								{{$default_currency->symbol}}@{{vehicle_detail_min_fare | number: 2}}
							</div>
						</div>
						<div class="row">
							<div class="col-md-8">
							...
							<div class="col-md-4" ng-cloak>
								{{$default_currency->symbol}}@{{(vehicle_detail_peak_fare) | number: 2}}
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-4" ng-cloak>
								{{$default_currency->symbol}}@{{vehicle_detail_total_fare | number: 2}}
							</div>
						</div>
					</div>
