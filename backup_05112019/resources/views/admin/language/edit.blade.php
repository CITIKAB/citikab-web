            ...
            {!! Form::open(['url' => 'admin/edit_language/'.$result->id, 'class' => 'form-horizontal']) !!}
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::select('is_translatable', array('1' => 'Yes', '0' => 'No'), old('is_translatable',$result->is_translatable), ['class' => 'form-control', 'id' => 'input_is_translatable', 'placeholder' => 'Select']) !!}
